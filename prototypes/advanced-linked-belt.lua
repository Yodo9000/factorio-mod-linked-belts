...
local name = "advanced-linked-belt"

local ingredient = "kr-advanced-underground-belt"

local subgroup = "belt" -- only belt

local belt = "advanced-transport-belt"
local ubelt = "advanced-underground-belt"
...
letters["advanced-linked-belt"]="d"
technologies["advanced-linked-belt"]="kr-logistic-4"
speeds["advanced-linked-belt"]=4*0.03125
...
local entity = {
  ...
  belt_animation_set = {
    animation_set = {
      filename = "__Krastorio2Assets__/entities/transport-belts/"..belt.."/transport-belt/"..belt..".png",
      priority = "extra-high",
      width = 64,
      height = 64,
      frame_count = 16,
      direction_count = 20,
      hr_version = {
        filename = "__Krastorio2Assets__/entities/transport-belts/"..belt.."/transport-belt/hr-"..belt..".png",
        priority = "extra-high",
        width = 128,
        height = 128,
        scale = 0.5,
