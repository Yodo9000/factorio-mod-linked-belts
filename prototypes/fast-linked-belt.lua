...
--local name = "express-linked-belt"

local ingredient = "fast-underground-belt"

local subgroup = "belt" -- only belt

local belt = "fast-transport-belt"
local ubelt = "fast-underground-belt"
...
local technologies = {
	...
	["fast-linked-belt"]="logistics-2",
	["express-linked-belt"]="logistics-3"
	}
...
--  dying_explosion = "underground-belt-explosion",
  ...
  belt_animation_set = {
    animation_set = {
      filename = "__base__/graphics/entity/"..belt.."/"..belt..".png",
      priority = "extra-high",
      width = 64,
      height = 64,
      frame_count = 16,
      direction_count = 20,
      hr_version = {
        filename = "__base__/graphics/entity/"..belt.."/hr-"..belt..".png",
        priority = "extra-high",
        width = 128,
        height = 128,
        scale = 0.5,
...
--  fast_replaceable_group = "linked-belts",
  ...
  structure = {
    ...
    back_patch = {
      sheet = {
        filename = "__base__/graphics/entity/"..ubelt.."/"..ubelt.."-structure-back-patch.png",
        priority = "extra-high",
        width = 96,
        height = 96,
        hr_version = {
          filename = "__base__/graphics/entity/"..ubelt.."/hr-"..ubelt.."-structure-back-patch.png",
          priority = "extra-high",
          width = 192,
          height = 192,
          scale = 0.5
    ...
    front_patch = {
      sheet = {
        filename = "__base__/graphics/entity/"..ubelt.."/"..ubelt.."-structure-front-patch.png",
        priority = "extra-high",
        width = 96,
        height = 96,
        hr_version = {
          filename = "__base__/graphics/entity/"..ubelt.."/hr-"..ubelt.."-structure-front-patch.png",
          priority = "extra-high",
          width = 192,
          height = 192,
          scale = 0.5
