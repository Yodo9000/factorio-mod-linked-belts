...
local name = "superior-linked-belt"

local ingredient = "kr-superior-underground-belt"

local subgroup = "belt" -- only belt

local belt = "superior-transport-belt"
local ubelt = "superior-underground-belt"
...
letters["superior-linked-belt"]="f"
technologies["superior-linked-belt"]="kr-logistic-5"
speeds["superior-linked-belt"]=6*0.03125
